            ...
            <div class="col-md-9">
               <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      ...
                      <a href="CreateQuestion.jsp" id="well-question"><div class="col-md-3 ">
                        <div class="well dash-box">
                          <h4>Create <br> Question </h4>
                        </div>
                         </div></a>

                        <a href="InstructorQuizSetting.jsp" id="well-question"><div class="col-md-3 ">
                        <div class="well dash-box">
                          <h4>Create <br> Quiz </h4>
                        </div>
                         </div></a>
                         
                         <a href="InstructorQuizSetting.jsp" id="well-question"><div class="col-md-3 ">
                        <div class="well dash-box">
                          <h4>Create <br> Question Set </h4>
                        </div>
                         </div></a>
