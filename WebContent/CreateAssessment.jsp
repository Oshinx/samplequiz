...
<%@page import="com.rewritingmolequiz.dao.InstructorDao"%>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<a href="./InstructorDataLoader?path=createquestion"
								id="well-question"><div class="col-md-3 ">
									<div class="well dash-box">
										<h4>
											Create <br> Question
										</h4>
									</div>
								</div></a> <a href="./InstructorDataLoader?path=assessquiz"
								id="well-question"><div class="col-md-3 ">
									<div class="well dash-box">
										<h4>
											Create <br> Quiz
							...
							<!--  <a href="./InstructorDataLoader?path=assesseset"
								id="well-question"><div class="col-md-3 ">
									<div class="well dash-box">
										<h4>
											Create <br> Question Set
										</h4>
									</div>
								</div></a> -->
