      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="./StudentDataLoader?path=result">Grades </a></li>
          ...
          <div class="row">
             <div class="col-md-3">
               <div class="list-group">
                      ...
                      <a href="./StudentDataLoader?path=result" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-check" aria-hidden="true"></span> Grades </a>
                    ...
                    <thead>
                     <tr>
                      ...
                      <th>Score</th>
                          ...
                          <tbody> 
                          <%
                           if(session.getAttribute("studentresult") != null){
                        	List<Result> list = (List) session.getAttribute("studentresult");
                        int counter =1;
