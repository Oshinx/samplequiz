  ...
  function displayQuestionComponent(e){
         ...
         if(form.checkValidity()){
           ...
           //change the value of the selected component to the course name and not the rtl
             ...
             var rtlcs = document.getElementById('rtllink');
         
             var createQbtn ;
                console.log(courseDirection);
          	...
          	console.log(("ltr" === courseDirection) +"jgjhgjgjg");
            ...
            if("rtl" === courseDirection){
              ...
              if("ltr" === courseDirection && rtlcs !== null){
            	//insert the  rtl css inside the head 
            	  console.log(rtlcs + " inside ");
            	rtlcs.remove();
