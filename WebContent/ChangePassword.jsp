<%@page import="com.rewritingmolequiz.utils.Mailer"%>
    ...
    <nav class="navbar navbar-default ">
     ...
     <header id="header">
       <div class="container">
         <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Change Password <small>Manage Quizoli</small></h1>
          </div>
          <div class="col-md-2">
          ...
          <div class="row">
             <div class="col-md-3">
               <div class="list-group">
                      ...
                      <a href="ChangePassword.jsp" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Change Password </a>
            ...
            <div class="col-md-9">
               <div class="panel panel-default">
                    <div class="panel-heading main-color-bg ">
                      <h3 class="panel-title main-color-bg">Change Password</h3>
                    </div>
                    <div class="panel-body">
                     ...
                     if(session.getAttribute("error") != null){
                          ...
                          String  sturegsuccess = session.getAttribute("error").toString();
                      ...
                      %>
                          ...
                          <form action="ChangePassword" method="post">
                              <div class="form-group">
                                ...
                                <input type="Password" name ="oldpassword" class="form-control" id="old_password"  placeholder="Enter Old Password" required="required">
                              </div>

                               <div class="form-group">
                                <label for="new_password">New Password</label>
                                <input type="Password" class="form-control" name="newpassword" id="new_password" minlength="8" placeholder="Enter New Password" required="required">
                              </div>

                              <div class="form-group">
                                <label for="re-enterpass">Re-Enter New Password</label>
                                <input type="Password" class="form-control" id="re-enterpass" minlength="8" placeholder="Enter New Password" required="required">
                              </div>

                              <button type="submit" class="btn btn-default btn-block pure-button pure-button-primary">Submit</button>
                          </form>
